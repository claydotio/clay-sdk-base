...
describe('sdk', function() {
  describe('version', function() {
    return it('has version', function() {
      return Clay.version.should.be('v0.0.0');
    });
  });
  return describe('client', function() {
    it('errors if not frame', function() {
      return Clay.client({
        method: 'kik.send'
      }).then(function(res) {
        throw new Error('Missing error');
      }, function(err) {
        return err.message.should.exist;
      });
    });
    return it('posts to parent frame', function() {
      window.parent = {
...
},{"clay-chai":7,"clay_sdk":40}],2:[function(require,module,exports){
(function () {
...
},{"chai":8}],8:[function(require,module,exports){
